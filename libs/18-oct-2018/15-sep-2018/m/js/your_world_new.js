...
function popups() {
  ...
  $('[data-xpop=\'trigger,xpop_yw\']').on({
    click: function (evt) {
      ...
      but.href = 'yourworld:Games/LiveParks/' + sku;
      // but.href = 'yourworld:Games/LiveParks/' + sku + '?name=Username';
      console.log('sku = ', sku);
    }
  })
...
var customStoreData = shopSettings_YW;
...
requirejs.config({
  ...
  paths: {
    ...
    'xsolla_genericpopups': 'https://cdn.xsolla.net/misc/mikelibs/genericpopups/latest/genericpopups.js',
    'swiper': 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.3.5/js/swiper.min',
    // 'xsolla_store': '../m/xsolla_store',
    'fragbuilder': '../m/libs/fragbuilder',
    ...
    'swiper_css_mike': '../m/css/swiper-add',
    // 'yw_css': 'http://xsolla.maiik.ru/xsolla-yw/css/your_world_new',
  }
});
...
define([
  ...
  window.yourWorldShop = new Xsolla(customStoreData);
